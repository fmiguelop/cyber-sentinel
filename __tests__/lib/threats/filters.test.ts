...
describe("filter utilities", () => {
  ...
  describe("matchesFilters", () => {
    ...
    it("should filter by time range (1min)", () => {
      const recentThreat = createMockThreat("low", "DDoS", 30 * 1000); // 30 seconds ago
      const oldThreat = createMockThreat("low", "DDoS", 90 * 1000); // 90 seconds ago
    ...
    it("should filter by time range (5min)", () => {
      const recentThreat = createMockThreat("low", "DDoS", 3 * 60 * 1000); // 3 minutes ago
      const oldThreat = createMockThreat("low", "DDoS", 6 * 60 * 1000); // 6 minutes ago
    ...
    it("should filter by time range (1hr)", () => {
      const recentThreat = createMockThreat("low", "DDoS", 30 * 60 * 1000); // 30 minutes ago
      const oldThreat = createMockThreat("low", "DDoS", 90 * 60 * 1000); // 90 minutes ago
    ...
    it("should match all threats when timeRange is 'all'", () => {
      const veryOldThreat = createMockThreat("low", "DDoS", 24 * 60 * 60 * 1000); // 24 hours ago
