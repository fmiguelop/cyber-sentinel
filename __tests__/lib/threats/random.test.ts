...
describe("random utilities", () => {
  describe("getRandomSeverity", () => {
    ...
    it("should return all severities over many calls", () => {
      ...
      expect(severities.size).toBeGreaterThanOrEqual(2); // Should get at least 2 different values
    });
  });
  ...
  describe("getRandomAttackType", () => {
    ...
    it("should return all attack types over many calls", () => {
      ...
      expect(types.size).toBeGreaterThanOrEqual(3); // Should get at least 3 different values
    });
  });
