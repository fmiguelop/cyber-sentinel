...
/**
 * Controls Card Component - Simulation controls + reset dialog + sound toggle
...
/**
 * Filters Card Component - Active Filters UI + Clear All
 * Extracted for reuse in mobile drawer
 */
...
export function ControlPanel() {
  ...
  // Compute filtered logs for export
  ...
  return (
    <Card className="h-fit border-border bg-card shadow-lg" role="region" aria-label="Control Panel">
      ...
      <CardContent className="space-y-5">
        {/* Use extracted ControlsCard */}
        <ControlsCard />

        {/* Use extracted FiltersCard */}
        <FiltersCard />
